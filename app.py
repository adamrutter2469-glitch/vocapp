...
with tab_words:
    ...
    if not all_words:
        ...
        words = _sort_words(all_words, st.session_state["words_sort"])
        total = len(words)
        ...
        # persists across pages/sort changes - counted here against every
        # word, not just the current page, so the count and the trash
